...
const Hero = () => (
  <section id="#home" className={`flex md:flex-row flex-col ${style.paddingY}`}>
    <div className={`flex-1 ${style.flexStart} flex-col xl:px-0 sm:px-16  px-6`}>
      ...
      <p className={`${style.paragraph} max-w-[470px] mt-5`}>Our team of experts uses a methodology to identify the credit cards most likely to fit your needs . We examine your annual percentage rates, annual fees. </p>
    </div>
    <div className={`flex-1 flex ${style.flexCenter} md:my-0 my-10 relative`}>
      ...
      <div className='w-[40%] absolute z-[0] h-[35%] top-0 pink__gradient' />
      <div className='w-[80%] absolute z-[1] h-[80%] bottom-40 rounded-full white__gradient' />
      <div className='w-[50%] absolute z-[0] h-[50%] right-20 bottom-20 blue__gradient' />
    </div>
